...
import "@openzeppelin/contracts@4.4.2/utils/cryptography/draft-EIP712.sol";

contract GameItem is ERC721, ERC721Enumerable, Pausable, AccessControl, ERC721Burnable, EIP712 {
    ...
    string private constant SIGNING_DOMAIN = "GameItem";
